...
func (_m *ExpenseSevice) Create(_a0 context.Context, _a1 *expenses.CreateExpenseInput) (*mongoentities.Expense, error) {
...
func (_c *ExpenseSevice_Create_Call) Return(_a0 *mongoentities.Expense, _a1 error) *ExpenseSevice_Create_Call {
