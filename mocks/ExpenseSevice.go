...
type mockConstructorTestingTNewExpenseSevice interface {
	mock.TestingT
	Cleanup(func())
}

// NewExpenseSevice creates a new instance of ExpenseSevice. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewExpenseSevice(t mockConstructorTestingTNewExpenseSevice) *ExpenseSevice {
	mock := &ExpenseSevice{}
	mock.Mock.Test(t)
