...
func (_m *CreateIncome) Create(ctx context.Context, incomeInput *incomes.CreateIncomeInput) (*entities.Income, error) {
	ret := _m.Called(ctx, incomeInput)

	var r0 *entities.Income
	if rf, ok := ret.Get(0).(func(context.Context, *incomes.CreateIncomeInput) *entities.Income); ok {
		r0 = rf(ctx, incomeInput)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*entities.Income)
		}
	}
...
func (_c *CreateIncome_Create_Call) Return(_a0 *entities.Income, _a1 error) *CreateIncome_Create_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

type mockConstructorTestingTNewCreateIncome interface {
	mock.TestingT
	Cleanup(func())
}

// NewCreateIncome creates a new instance of CreateIncome. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewCreateIncome(t mockConstructorTestingTNewCreateIncome) *CreateIncome {
	mock := &CreateIncome{}
	mock.Mock.Test(t)
