...
type mockConstructorTestingTNewExpenseUpdateable interface {
	mock.TestingT
	Cleanup(func())
}

// NewExpenseUpdateable creates a new instance of ExpenseUpdateable. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewExpenseUpdateable(t mockConstructorTestingTNewExpenseUpdateable) *ExpenseUpdateable {
	mock := &ExpenseUpdateable{}
	mock.Mock.Test(t)
