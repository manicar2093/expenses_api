...
type mockConstructorTestingTNewIncomesRepository interface {
	mock.TestingT
	Cleanup(func())
}

// NewIncomesRepository creates a new instance of IncomesRepository. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewIncomesRepository(t mockConstructorTestingTNewIncomesRepository) *IncomesRepository {
	mock := &IncomesRepository{}
	mock.Mock.Test(t)
