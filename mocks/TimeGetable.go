...
type mockConstructorTestingTNewTimeGetable interface {
	mock.TestingT
	Cleanup(func())
}

// NewTimeGetable creates a new instance of TimeGetable. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewTimeGetable(t mockConstructorTestingTNewTimeGetable) *TimeGetable {
	mock := &TimeGetable{}
	mock.Mock.Test(t)
