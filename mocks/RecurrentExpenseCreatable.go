...
type mockConstructorTestingTNewRecurrentExpenseCreatable interface {
	mock.TestingT
	Cleanup(func())
}

// NewRecurrentExpenseCreatable creates a new instance of RecurrentExpenseCreatable. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewRecurrentExpenseCreatable(t mockConstructorTestingTNewRecurrentExpenseCreatable) *RecurrentExpenseCreatable {
	mock := &RecurrentExpenseCreatable{}
	mock.Mock.Test(t)
