...
func (_m *RecurrentExpenseRepo) FindAll(ctx context.Context, userID uuid.UUID) ([]*entities.RecurrentExpense, error) {
	ret := _m.Called(ctx, userID)

	var r0 []*entities.RecurrentExpense
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUID) []*entities.RecurrentExpense); ok {
		r0 = rf(ctx, userID)
	} else {
		if ret.Get(0) != nil {
...
//   - ctx context.Context
//   - userID uuid.UUID
func (_e *RecurrentExpenseRepo_Expecter) FindAll(ctx interface{}, userID interface{}) *RecurrentExpenseRepo_FindAll_Call {
	return &RecurrentExpenseRepo_FindAll_Call{Call: _e.mock.On("FindAll", ctx, userID)}
}

func (_c *RecurrentExpenseRepo_FindAll_Call) Run(run func(ctx context.Context, userID uuid.UUID)) *RecurrentExpenseRepo_FindAll_Call {
...
// FindByName provides a mock function with given fields: ctx, name, userID
func (_m *RecurrentExpenseRepo) FindByName(ctx context.Context, name string, userID uuid.UUID) (*entities.RecurrentExpense, error) {
	ret := _m.Called(ctx, name, userID)

	var r0 *entities.RecurrentExpense
	if rf, ok := ret.Get(0).(func(context.Context, string, uuid.UUID) *entities.RecurrentExpense); ok {
...
//   - name string
//   - userID uuid.UUID
func (_e *RecurrentExpenseRepo_Expecter) FindByName(ctx interface{}, name interface{}, userID interface{}) *RecurrentExpenseRepo_FindByName_Call {
	return &RecurrentExpenseRepo_FindByName_Call{Call: _e.mock.On("FindByName", ctx, name, userID)}
}

func (_c *RecurrentExpenseRepo_FindByName_Call) Run(run func(ctx context.Context, name string, userID uuid.UUID)) *RecurrentExpenseRepo_FindByName_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
type mockConstructorTestingTNewRecurrentExpenseRepo interface {
	mock.TestingT
	Cleanup(func())
}

// NewRecurrentExpenseRepo creates a new instance of RecurrentExpenseRepo. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewRecurrentExpenseRepo(t mockConstructorTestingTNewRecurrentExpenseRepo) *RecurrentExpenseRepo {
	mock := &RecurrentExpenseRepo{}
	mock.Mock.Test(t)
